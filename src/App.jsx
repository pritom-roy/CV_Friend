    ...
    <div className="max-w-4xl mx-auto py-4 px-8 bg-white font-sans text-justify">
      ...
      <section className="mb-3">
        ...
        <p className="text-gray-700 text-justify">
          A dedicated Software Engineer with proven expertise in competitive programming and mobile application development. I seek opportunity in contributing to cutting-edge technology, advance research, and foster innovation in the evolving field of computer science while deepening my knowledge through higher education.
